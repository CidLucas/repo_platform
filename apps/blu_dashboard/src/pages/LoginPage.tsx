...
const LoginPage: React.FC = () => {
        ...
        try {
          ...
          if (hasCodeParam) {
            ...
            if (code) {
              ...
              // Session is now established, the user useEffect will handle redirect
              window.history.replaceState(null, '', window.location.pathname);
              return;
            }
          }

          // For implicit flow (hash token), Supabase handles it automatically
          if (hasHashToken) {
  ...
  //
  // Novos usuários (ou qualquer sessão com `clientes_blu.onboarding_completed_at`
        ...
        >
          <VStack spacing={8} w="100%" maxW="440px">
            ...
            <HStack spacing={2} mb={4}>
              <Image src="/Group 2049761270.png" alt="BLU" h="40px" />
            </HStack>
