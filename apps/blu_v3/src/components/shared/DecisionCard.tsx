    ...
    <div className={`dc warn${expanded ? ' expanded' : ''}`}>
      ...
      <div className="dc-expand">
        ...
        <div className="dc-act">
          <button className="btn bp" onClick={(e) => { e.stopPropagation(); onApprove() }}><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg> Ativar</button>
          <button className="btn bs" onClick={(e) => { e.stopPropagation(); onReject() }}><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg> Rejeitar</button>
        </div>
      </div>
    </div>
  )
  ...
  return (
    <div className={cls} id={approval.id}>
      ...
      <div className="dc-expand">
        ...
        <div className="dc-act">
          <button className="btn bp" onClick={(e) => { e.stopPropagation(); handleApprove() }}><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg> Aprovar</button>
          ...
          <button className="btn bs" onClick={(e) => { e.stopPropagation(); handleReject() }}><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg> Rejeitar</button>
        </div>
      </div>
    </div>
  )
