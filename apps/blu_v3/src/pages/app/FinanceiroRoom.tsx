...
import { IconCheck, IconClock, IconX } from '../../components/shared/Icons'
                  ...
                  return (
                    <div key={approval.id} className={cls} id={approval.id}>
                      <div className="dc-row" onClick={() => toggleDc(approval.id)}>
                        <div className="ag">
                          <div className="agd" style={{ background: 'var(--teal)' }} />Boleto
                        </div>
                      ...
                      <div className="dc-expand">
                        ...
                        <div className="dc-act">
                          <button className="btn bp" onClick={() => approveMut.mutate(approval.id)}><IconCheck /> Agendar</button>
                          <button className="btn bg" onClick={() => snoozeMut.mutate(approval.id)}><IconClock /> Depois</button>
                          <button className="btn bs" onClick={() => rejectMut.mutate(approval.id)}><IconX /> Rejeitar</button>
                        </div>
                      </div>
                    </div>
                  )
