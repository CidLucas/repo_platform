...
│                      │  │                              │  │ (Deno + service token) │
│                      │  │ get_recent_activity          │  └───────────────────────┘
│ get_pedidos_overview │  │ get_pendencias               │            │
│ _scorecards          │  │ get_agent_runs_today         │            │ uses
│                      │  │ get_nps_score                │            ▼
└──────────────────────┘  └──────────────────────────────┘  ┌───────────────────────┐
       │                              │                     │ libs/vizu_google_     │
       ▼                              ▼                     │ suite_client (Python  │
...
4. **Geo card** ([`PedidosPage.tsx:296`](../../apps/vizu_dashboard/src/pages/PedidosPage.tsx#L296))
