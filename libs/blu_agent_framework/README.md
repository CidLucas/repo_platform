...
Reusable LangGraph agent framework for Blu multi-agent architecture.
...
```python
from blu_agent_framework import AgentConfig, AgentBuilder
...
```python
from blu_agent_framework import AgentBuilder, NodeRegistry
