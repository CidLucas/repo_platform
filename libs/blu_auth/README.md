...
Centralized authentication library for the Blu monorepo.
...
blu-auth = { path = "../../libs/blu_auth", develop = true }
```
...
from blu_auth.fastapi.dependencies import get_auth_result  # noqa: F401
...
from blu_auth.core.models import JWTClaims
...
| `standalone_agent_api` | `api/auth.py` | Re-exports from `blu_auth.fastapi.dependencies` |
