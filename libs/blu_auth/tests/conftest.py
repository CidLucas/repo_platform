"""
Pytest fixtures for blu_auth tests.
"""
...
# Configure env before importing blu_auth modules in tests
...
from blu_auth.core.config import clear_auth_settings_cache
