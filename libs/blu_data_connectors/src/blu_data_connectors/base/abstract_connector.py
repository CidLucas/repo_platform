# libs/blu_data_connectors/base/abstract_connector.py

from abc import ABC, abstractmethod
from typing import Any

# O conector abstrato deve usar a CredencialBase do blu_models (ou do schemas.py da API)
...
class ExecutionError(Exception):
    """Exceção personalizada para erros de execução em conectores de dados (Padrão Blu)."""
    pass
