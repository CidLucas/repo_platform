...
# [BLU-REFACTOR] CORRIGIDO: Importa a exceção correta
from google.api_core.exceptions import GoogleAPICallError
from google.cloud import bigquery

# Importamos o conector abstrato para garantir a interface Blu
from blu_data_connectors.base.abstract_connector import AbstractDataConnector, ExecutionError

# [BLU-REFACTOR] Nome do logger definido no topo do arquivo
...
class BigQueryConnector(AbstractDataConnector):
    ...
    async def extract_data(
        ...
        """
        [BLU-REFACTOR] Implementação assíncrona.
    ...
    # [BLU-REFACTOR] Esta é a sua lógica de paginação, agora chamada pela 'extract_data'
