...
from blu_models import SEED_CLIENTS, ClienteBlu
...
def run_LOCAL_DATABASE(db_url: str):
    ...
    É chamada automaticamente pelo comando 'blu-db LOCAL_DATABASE'.
    """
    ...
    with Session(engine) as session:
        ...
        for client_data in SEED_CLIENTS:
            ...
            statement = select(ClienteBlu).where(ClienteBlu.nome_empresa == nome)
