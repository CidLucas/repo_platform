# libs/blu_db_connector/src/blu_db_connector/operations.py
...
class BluDBConnector:
    ...
    async def create_or_get_conversa(
        ...
        Args:
            ...
            client_id: ID do cliente Blu (obrigatório para RLS)
        """
        with self._get_db() as db:
            import uuid

            from blu_models import Conversa
    ...
    async def add_mensagem(
        ...
        with self._get_db() as db:
            ...
            from blu_models import Mensagem, Remetente
