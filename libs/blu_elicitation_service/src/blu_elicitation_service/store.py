...
from blu_elicitation_service.exceptions import ElicitationNotFoundError
from blu_elicitation_service.models import PendingElicitation
...
class PendingElicitationStore:
    ...
    def __init__(
        ...
        key_prefix: str = "blu:elicitation:",
    ):
        """
        Initialize store.
