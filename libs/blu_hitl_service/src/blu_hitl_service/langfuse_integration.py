# libs/blu_hitl_service/src/blu_hitl_service/langfuse_integration.py
"""
...
from blu_models import HitlReviewRead, HitlReviewStatus
    ...
    def add_review_to_dataset(
        ...
        try:
            ...
            self.get_or_create_dataset(
                ...
                metadata={"source": "blu_hitl_service", "type": "training"},
            )
