...
It provides:
- Context extraction from BluClientContext
- Variable substitution with schema info, allowed views/columns
- Template loading with database fallback (via blu_prompt_management)
...
class TextToSqlLLMCall:
    ...
    def _build_system_prompt(self) -> str:
        ...
        Uses builtin template from blu_prompt_management (sync-only, no Langfuse).
