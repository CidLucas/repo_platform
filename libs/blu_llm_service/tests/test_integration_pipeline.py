...
from blu_llm_service.text_to_sql_config import TextToSqlLLMResponse
...
class TestPipelineIntegrationWithComponents:
    ...
    @pytest.mark.asyncio
    async def test_prompt_uses_blu_prompt_management(
        self, mock_prompt_loader, mock_context, realistic_schema
    ):
        """Test that TextToSqlPrompt properly uses blu_prompt_management."""
        prompt_builder = TextToSqlPrompt(prompt_loader=mock_prompt_loader)
