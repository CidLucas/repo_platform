# blu_models/safe_client_context.py
"""
...
class InternalClientContext(BaseModel):
    ...
    @classmethod
    def from_blu_client_context(
        cls,
        ctx: Any,
        sections: dict[ContextSection, dict] | None = None,
    ) -> "InternalClientContext":
        """
        Create from BluClientContext with optional pre-loaded sections.

        Args:
            ctx: BluClientContext from database
