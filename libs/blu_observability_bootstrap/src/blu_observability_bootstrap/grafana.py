"""
Grafana Cloud integration module for Blu services.
...
Usage:
    from blu_observability_bootstrap.grafana import setup_grafana_logging, create_grafana_logger
...
def record_metric(
    ...
    Args:
        metric_name: Name of the metric (e.g., "blu.chat.response_time_ms")
        value: Metric value
    ...
    try:
        ...
        meter = metrics.get_meter("blu.custom")
