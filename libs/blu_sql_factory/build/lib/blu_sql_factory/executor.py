...
Text-to-SQL Executor
    ...
    Reuses:
    - blu_supabase_client.PostgRESTQueryExecutor for safe query execution
    - blu_supabase_client.AuthContext for multi-client isolation
    - blu_supabase_client.JWTContextExtractor for JWT handling
    """
...
from blu_sql_factory.checks import SqlValidator, ValidationResult
from blu_sql_factory.observability import SqlValidationObserver, ValidationTimer
from blu_sql_factory.parser import SqlParser
from blu_sql_factory.rewrites import SqlRewriter
from blu_supabase_client import (
    AuthContext,
