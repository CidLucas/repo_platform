...
#
# Para operações CRUD simples, use blu_supabase_client que usa a API REST
# do Supabase e não tem problemas de DNS/conectividade.
#
# Ambientes:
# - LOCAL: DATABASE_URL postgresql://user:password@localhost:5432/blu_db
# - DOCKER: DATABASE_URL postgresql://user:password@postgres:5432/blu_db
...
def get_shared_engine() -> Engine:
    ...
    when combined with blu_db_connector pools from other services.
