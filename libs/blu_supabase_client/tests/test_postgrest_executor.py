...
from blu_supabase_client.auth_context import AuthContext
...
class TestPostgRESTQueryExecutor:
    ...
    def test_query_limit_capped(self, executor):
        ...
        with patch("blu_supabase_client.postgrest_executor.get_supabase_client", return_value=mock_client):
