...
```python
from blu_tool_registry import ToolRegistry, TierValidator
...
```python
from blu_tool_registry import DockerMCPBridge
...
```toml
blu-tool-registry = { path = "../../libs/blu_tool_registry", develop = true }
```
