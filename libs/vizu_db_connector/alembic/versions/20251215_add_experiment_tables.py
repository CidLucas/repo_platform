...
def upgrade() -> None:
    ...
    op.create_table(
        'experiment_case',
        sa.Column('id', postgresql.UUID(as_uuid=True), primary_key=True),
        sa.Column('run_id', postgresql.UUID(as_uuid=True), sa.ForeignKey('experiment_run.id'), nullable=False, index=True),
        sa.Column('case_id', sa.String(), nullable=False, index=True),
        sa.Column('cliente_id', postgresql.UUID(as_uuid=True), nullable=False, index=True),
        ...
        # HITL link
        sa.Column('hitl_review_id', postgresql.UUID(as_uuid=True), sa.ForeignKey('hitl_review.id'), nullable=True),
    ...
    op.create_index('ix_experiment_case_classification', 'experiment_case', ['classification'])
