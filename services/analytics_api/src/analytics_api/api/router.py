...
api_router.include_router(rankings.router, prefix="/analytics")  # /api/v1/analytics/clientes/overview
api_router.include_router(deep_dive.router, prefix="/analytics")   # /api/v1/analytics/cliente/{nome}