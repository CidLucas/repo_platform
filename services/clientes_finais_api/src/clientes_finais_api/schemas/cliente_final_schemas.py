...
class ClienteFinalUpdate(ClienteFinalBase):
    ...
    """
    id_externo: str | None = Field(None, description="O identificador principal do cliente final. Ex: número de telefone.")
    nome: str | None = Field(None, max_length=255)
    metadados: Dict[str, Any] | None = Field(None, description='Campo flexível para dados não estruturados.')
