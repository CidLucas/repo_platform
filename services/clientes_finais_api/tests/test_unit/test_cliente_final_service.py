...
def test_create_cliente_final_service():
    ...
    cliente_data = ClienteFinalCreate(id_externo="whatsapp:12345", nome="Cliente Teste Unitário")

    # ACT
    service.create_cliente_final(cliente_in=cliente_data, cliente_vizu_id=cliente_vizu_id)
