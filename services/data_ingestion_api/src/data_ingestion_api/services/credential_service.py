...
import logging
from data_ingestion_api.schemas.schemas import BigQueryCredentialCreate, SQLCredentialCreate, CredencialResponse
...
class CredentialService:
    ...
    async def create_credential(self, credenciais: Union[SQLCredentialCreate, BigQueryCredentialCreate]) -> CredencialResponse:
        """
