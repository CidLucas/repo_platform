...
def register_tools(mcp: FastMCP) -> list[str]:
    ...
    async def write_to_sheet_wrapper(
        ...
        return await _write_to_sheet_logic(
            spreadsheet_id, range_name, values, client_id, account_email
        )
    ...
    async def read_emails_wrapper(
        ...
        Args:
            ...
            account_email: Optional Google account email to use (uses default if not specified)
        """
        return await _read_emails_logic(query, max_results, client_id, account_email)
    ...
    async def list_google_accounts_wrapper(
        ...
        """
        return await _list_google_accounts_logic(client_id)
    ...
    async def list_spreadsheets_wrapper(
        ...
        """
        return await _list_spreadsheets_logic(client_id, max_results, account_email)
    ...
    async def export_to_sheet_wrapper(
        ...
        return await _export_data_to_sheet_logic(
            spreadsheet_id, sheet_name, values, client_id, account_email
        )
    ...
    async def create_spreadsheet_with_data_wrapper(
        ...
        Args:
            ...
            account_email: Optional Google account to use
        """
        return await _create_spreadsheet_with_data_logic(title, values, client_id, account_email)
    ...
    async def google_docs_create_wrapper(
        ...
        Args:
            ...
            account_email: Optional Google account to use
        """
        return await _create_document_logic(title, client_id, account_email)
    ...
    async def google_docs_read_wrapper(
        ...
        Args:
            ...
            account_email: Optional Google account to use
        """
        return await _read_document_logic(document_id, client_id, account_email)
    ...
    async def google_docs_write_wrapper(
        ...
        return await _write_document_logic(
            document_id, text, client_id, mode, old_text, account_email
        )
...
- account_email: (optional string) Specific Google account to use"""
    ...
    )(_inject(write_to_sheet_wrapper))
...
- User wants to check availability or upcoming meetings
...
- account_email: (optional string) Specific Google account to use"""
    ...
    )(_inject(list_google_accounts_wrapper))
    ...
    )(_inject(list_spreadsheets_wrapper))
    ...
    )(_inject(export_to_sheet_wrapper))
    ...
    )(_inject(create_spreadsheet_with_data_wrapper))
...
- account_email: (optional string) Specific Google account to use"""
    ...
    )(_inject(google_docs_create_wrapper))
...
- account_email: (optional string) Specific Google account to use"""
    ...
    )(_inject(google_docs_read_wrapper))
...
- User wants to append content or find-and-replace text
...
- account_email: (optional string) Specific Google account to use"""
    ...
    )(_inject(google_docs_write_wrapper))
