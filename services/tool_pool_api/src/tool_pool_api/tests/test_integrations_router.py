...
class FakeContext:
    ...
    async def save_integration_config(
        ...
        self.saved_config = {
            ...
            "client_id_encrypted": f"enc:{oauth_client_id}",
...
def app(monkeypatch):
    ...
    app.dependency_overrides[_get_context_service] = lambda: fake_ctx
    app.dependency_overrides[integrations_router._get_auth_result] = _fake_auth_result
    return app
