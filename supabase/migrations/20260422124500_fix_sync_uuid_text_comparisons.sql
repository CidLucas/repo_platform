-- =============================================================================
-- Migration: Fix UUID/TEXT comparisons in sincronizar_dados_cliente
-- Date: 2026-04-22
-- Root cause:
--   - client_data_sources.client_id is UUID, but function compared to p_client_id::text
--   - analytics_v2.reg_jobs.client_id is TEXT, but function compared to p_client_id (UUID)
-- =============================================================================
